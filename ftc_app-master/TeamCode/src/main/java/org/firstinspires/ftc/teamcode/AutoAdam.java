...
@Autonomous(name="AutoAdam", group="Color1")

public class AutoAdam extends LinearOpMode{
...
//            motor3.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            runtime.reset();
            while((motor2.getCurrentPosition()< newLeftTarget2)&&(motor4.getCurrentPosition()<newRightTarget2)){
